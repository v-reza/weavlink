...
const SidebarMobile = ({ postedJobs }) => {
  const navigation = [{ name: "My Jobs", href: "#", icon: BriefcaseIcon }];
  return (
              ...
              <div className="p-6">
                <div className="flex items-center justify-between text-sm font-medium rounded-md dark:text-white">
                  <div className="flex items-center border-l-4 border-blue-500">
                    <span className="ml-4 truncate">Posted Jobs</span>
                    <span className="ml-4 dark:text-slate-200 text-sm">
                      {postedJobs?.length}
                    </span>
                  </div>
