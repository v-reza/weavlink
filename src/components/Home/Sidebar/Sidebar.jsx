...
const Sidebar = () => {
  ...
  const navigation = [
    ...
    { name: "Applicant", href: "#", icon: UsersIcon, current: false },
      ...
      <div className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 lg:border-r lg:border-gray-200 lg:pt-5 lg:pb-4 lg:bg-gray-100">
        ...
        <div className="mt-6 h-0 flex-1 flex flex-col overflow-y-auto">
          ...
          <Menu as="div" className="px-3 relative inline-block text-left">
            <div>
              <Menu.Button className="group w-full bg-gray-100 rounded-md px-3.5 py-1 text-sm text-left font-medium text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-3 focus:ring-offset-gray-100 focus:ring-purple-500">
