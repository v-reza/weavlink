...
export default function Select() {
  const job = [
    { id: 1, name: "Select a source" },
    { id: 2, name: "SiriusXM Satellite Radio" },
    { id: 3, name: "In the mail" },
    { id: 4, name: "Podcast" },
    { id: 5, name: "TV" },
    { id: 6, name: "Radio" },
    { id: 7, name: "Ad on velkey.tech" },
    { id: 8, name: "Online ad / Search engine" },
    { id: 9, name: "Streaming Audio (Spotify/Pandora/iHeart/Deezer)" },
  ];
