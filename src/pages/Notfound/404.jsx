...
const Notfound = ({ setIsNotfound }) => {
  ...
  return (
    <>
      <div className="h-screen w-screen bg-gray-100 dark:bg-slate-900/75 flex items-center">
        <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
          <div className="max-w-md">
            <div className="text-5xl font-dark font-bold dark:text-slate-100">404</div>
            <p className="text-2xl md:text-3xl font-light leading-normal dark:text-slate-200">
